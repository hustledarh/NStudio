...
function Footer(){
    return(
       <Container className="footer mt-5 pb-3 pt-5 pb-5" id="about">
        <h2 className="pt-3 text-center">“About us, who we are, and what we do.”</h2>

         <hr class="hr" />
        <Row  className="justify-content-center">
            <Col >
            <p className="text-center about px-2"> Studio N, is our little online store with customised products, with all the love and care! 
